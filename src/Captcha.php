...
class Captcha
{
     ...
     */
    protected $callbackName = 'NotixNoCaptchaOnLoadCallback';
     ...
     */
    protected $widgetIdName = 'NotixNoCaptchaWidgetIds';
    ...
    {
        return 'NotixNoCaptchaId_' . md5(uniqid(rand(), true));
    }
